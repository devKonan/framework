...
<section id="fonctionnalites">
  ...
  <div class="features">
    ...
    <div class="feat fade-in">
      ...
      <div class="feat-tags"><span class="tag">database</span><span class="tag">PDO</span></div>
    </div>
    <div class="feat fade-in">
      ...
      <div class="feat-tags"><span class="tag">sms</span><span class="tag">OTP</span></div>
    </div>
    <div class="feat fade-in">
      <div class="feat-icon">✉️</div>
      <h3>Mail natif</h3>
      <p>SMTP via sockets PHP (TLS/SSL/STARTTLS), SendGrid, Mailgun. Templates PHP, pièces jointes, Mailable.</p>
      <div class="feat-tags"><span class="tag">mail</span><span class="tag">SMTP</span></div>
    </div>
    <div class="feat fade-in">
      <div class="feat-icon">📶</div>
      <h3>Low Bandwidth</h3>
      <p>Mode économique automatique : gzip, sélection de champs, suppression des nulls. Idéal pour 2G/3G.</p>
      <div class="feat-tags"><span class="tag">http</span><span class="tag">gzip</span></div>
    </div>
    <div class="feat fade-in">
      <div class="feat-icon">🔌</div>
      <h3>Offline-First</h3>
    ...
    <div class="feat fade-in">
      ...
      <div class="feat-tags"><span class="tag">console</span><span class="tag">JSON</span></div>
    </div>
    <div class="feat fade-in">
      <div class="feat-icon">⚡</div>
      <h3>CLI puissant</h3>
      <p>Générateurs, migrations, sync offline, test SMS/Mail, tail logs — tout depuis le terminal.</p>
      <div class="feat-tags"><span class="tag">console</span><span class="tag">CLI</span></div>
    </div>
  </div>
</section>
...
<div style="background:var(--dark2); border-top:1px solid var(--border); border-bottom:1px solid var(--border);">
  <section id="commandes">
    <p class="section-label">CLI — console</p>
